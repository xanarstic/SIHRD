                ...
                <div class="col-md-4">
                    <div class="job-card">
                        <div class="job-header">
                            <div class="job-title"><?= $lowongan->nama_lowongan ?></div>
                        </div>
                        <div class="job-details mt-3">
                            <p><strong>Job Requirements:</strong> <?= $lowongan->syarat ?></p>
                        </div>
                        <div class="job-details mt-3">
                            <p><strong>ID:</strong> <?= $lowongan->id_lowongan ?></p>
                        </div>
                        <div class="d-flex justify-content-between">
                            <?php if ($lowongan->sudah_lamar): ?>
                                <!-- Jika sudah melamar, tampilkan notifikasi -->
                            ...
                            <?php endif; ?>
                            <?php if ($level == 'HRD' || $level == 'admin'): ?>
                                <button class="btn btn-warning btn-sm" data-id="<?= $lowongan->id_lowongan ?>"
                                    data-bs-toggle="modal" data-bs-target="#editLowonganModal">Edit</button>
                                <a href="/home/deleteLowongan/<?= $lowongan->id_lowongan ?>" class="btn btn-danger btn-sm"
