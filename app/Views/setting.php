        ...
        <div class="container mt-5">
            ...
            <form action="/home/updatesetting" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="namawebsite" name="namawebsite" value="<?= old('namawebsite', $setting['namawebsite']) ?>" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <?php if (!empty($setting['icontab'])): ?>
                        <p>Current Icon: <img src="<?= base_url('public/' . $setting['icontab']) ?>" alt="Icon Tab" width="50"></p>
                    <?php endif; ?>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <?php if (!empty($setting['iconlogin'])): ?>
                        <p>Current Icon: <img src="<?= base_url('public/' . $setting['iconlogin']) ?>" alt="Icon Login" width="50"></p>
                    <?php endif; ?>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <?php if (!empty($setting['iconmenu'])): ?>
                        <p>Current Icon: <img src="<?= base_url('public/' . $setting['iconmenu']) ?>" alt="Icon Menu" width="50"></p>
                    <?php endif; ?>
                </div>
