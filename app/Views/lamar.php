                    ...
                    <tbody>
                        <?php foreach ($pelamars as $pelamar): ?>
                            <tr>
                                ...
                                <td><span
                                        class="btn btn-sm <?= $pelamar['status'] == 'Pending' ? 'btn-warning' : ($pelamar['status'] == 'Diterima' ? 'btn-success' : 'btn-danger') ?>"><?= $pelamar['status'] ?></span>
                                </td>
                                <td>
                                    <form action="/home/deletePelamar" method="POST" class="d-inline">
                                        <input type="hidden" name="id_pelamar" value="<?= $pelamar['id_pelamar'] ?>">
                                        <button type="submit" class="btn btn-danger btn-sm"
                                            onclick="return confirm('Apakah Anda yakin ingin menghapus pelamar ini?')">Delete</button>
                                    </form>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                lowonganModal.addEventListener('show.bs.modal', function (event) {
                    ...
                    fetch('/home/getLowonganById', {
                        ...
                        body: JSON.stringify({ id_lowongan: idLowongan })
                    })
